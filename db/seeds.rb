...
avi = User.create([{name: "Avi", email: "avi@flombaum.com", password_digest: "itest", permission_type: "instructor"}])
...
ian = User.create({name: "Ian", email: "ian@miller.com", password_digest: "stest", permission_type: "student"})

stephanie = User.create({name: "Stephanie", email: "stephanie@oh.com", password_digest: "stest1", permission_type: "student"})
